...
#define TIME_TO_SLEEP  10       // Le temps durant lequel le microcontroleur va dormir (en secondes)

void setup() {
    Serial.begin(115200);
    
    esp_sleep_enable_timer_wakeup(TIME_TO_SLEEP * uS_TO_S_FACTOR);
    esp_sleep_enable_ext0_wakeup(GPIO_NUM_12, HIGH); //Quand on appuie sur le bouton, le microcontroleur se réveille
