...
void loop(){
  ...
  char request[] = "http://192.168.101.100/collecte/test.php?name=PERRIN&time=12:00:00&temp=2013&lum=1247" // ou alors collecte.php
  String time = timeClient.getFormatedTime();  
