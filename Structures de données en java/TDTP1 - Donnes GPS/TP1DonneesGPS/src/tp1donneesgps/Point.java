...
public class Point {
   ...
   //-------------------------------------------------------------------------------------------------
   public Point( double latitude, double longitude, double altitude, double intervaleTemps ) /*Constructeur de la classe point**/ {
      this.lat = latitude;
      this.lon = longitude;
      this.alt = altitude;
   ...
   public String toString() {
     ...
     * @return la distance entre les points en km
     */
