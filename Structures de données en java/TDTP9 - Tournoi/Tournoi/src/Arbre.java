...
class ArbreCons extends Arbre {
	...
	public int hauteur() {
        ...
        /*
        Faites une méthode qui effectue la recherche d'un élément dans un arbre public boolean trouver ( String element)
        @Override
        public boolean trouver(String element) {
        }*/
        
       //Faites une méthode qui donne l'élément le plus à droite dans l'arbre public String lePlusAGauche ()
        public String lePlusADroite() {
            if (this.Ad.nbFeuilles() > this.Ag.nbFeuilles()) {
                System.out.println("Element le plus à droite : " +  this.Ag.nbFeuilles());
            }
            return null;
        }
        ...
        /*
        public Arbre suppr (String valeur) {
