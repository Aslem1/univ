...
static char unit[10][16] = {"", "un", "deux", "trois", "quatre", "cinq", "six", "sept", "huit", "neuf"};
...
static char *hundred(long number) {
    ...
    else if (h > 0) /* If it is greater than 0 */
    {
